...
const UserWidget = ({ userId, picturePath }) => {
  ...
  const [toggleFriendList, setToggleFriendList] = useState(false);
    ...
    <WidgetWrapper>
      {!toggleFriendList ? (
        <>
          ...
          >
            ...
            <Box display="grid" justifyContent="end">
              <ManageAccountsOutlined sx={{ ml: "1.5rem" }} />
              {!isNonMobileSCreen && (
                <Button
                  style={{
                    height: "15px",
                  ...
                  onClick={() => setToggleFriendList(!toggleFriendList)}>
                  Friend List
                </Button>
              )}
            </Box>
        ...
        <FriendListWidget
          ...
          setToggleFriendList={setToggleFriendList}
          userId={_id}
        />
      )}
    </WidgetWrapper>
